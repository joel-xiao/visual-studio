  ...
  <div class="ws-editor-header">
    <div class="header-breadcrumb">
      <div class="crumb-item">
        <BasicIcon icon="mdi:lan" font-size="14px" />
      ...
      <div class="crumb-item active">
        ...
        <BasicIcon v-else-if="currentStep.action === 'listen'" icon="mdi:ear-hearing" font-size="14px" />
        <BasicIcon v-else icon="mdi:send-circle-outline" font-size="14px" />
        <span>{{ currentStep.name || (currentStepIndex === -2 ? 'WS 配置' : '未命名步骤') }}</span>
      </div>
    </div>
    ...
    <div class="header-metadata">
      ...
      <div class="meta-item">
        ...
        <div class="protocol-badge">
          <BasicIcon icon="mdi:swap-horizontal-bold" font-size="16px" />
...
const configName = computed(() => props.configName || 'Websocket 接入');
...
.ws-editor-header {
  ...
  .header-metadata {
    ...
    .id-badge {
      ...
      .value { font-family: 'Fira Code', monospace; color: var(--ws-color-primary); font-size: 11px; }
    ...
    .status-indicator {
      ...
      &.connecting { color: var(--ws-color-primary); }
