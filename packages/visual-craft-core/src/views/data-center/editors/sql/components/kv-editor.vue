  ...
  <div class="kv-editor-light">
    ...
    <div class="rows-container">
      <div v-for="(item, index) in localItems" :key="index" class="kv-row">
        <div class="col key">
          <CInput v-model="item.key" icon="mdi:tag-outline" placeholder="Key" @input="onInput" />
        </div>
        <div class="col val">
          <CInput v-model="item.value" icon="mdi:code-brackets" placeholder="Value" @input="onInput" />
        </div>
        <div class="col desc">
          <CInput v-model="item.description" icon="mdi:text-box-outline" placeholder="Description" @input="onInput" />
        </div>
        <div class="col actions">
          <CButton 
            quaternary 
...
.kv-editor-light {
  ...
  .col {
    ...
    .c-button {
      ...
      &:hover:not(:disabled) { color: var(--sql-color-primary); }
    }
  }
