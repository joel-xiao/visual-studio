...
export type OverlayApi = {
  addOverlay: (opt: OverlayOption) => void;
  overlayUpdatePos: () => void;
  addOverlayMoveUpdated: (fn: CallbackUpdate) => void;
  setOverlayDisabled: (disabled: boolean) => void;
  getPos: () => Pos;
  getScaleOffset: () => Pos;
  setScaleOffset: (pos: Pos) => void;
...
export const useOverlay = function (): Readonly<OverlayApi> {
