...
export class Overlay {
    ...
    constructor() {
        ...
        this.overlayUpdatePos = this.overlayUpdatePos.bind(this);
        this.addOverlayMoveUpdated = this.addOverlayMoveUpdated.bind(this);
        this.setOverlayDisabled = this.setOverlayDisabled.bind(this);
        this.overlaySetPos = this.overlaySetPos.bind(this);
    }
    ...
    // Aliases for backward compatibility/consistency with old API
    addOverlay(opt: OverlayOption) { this.install(opt); }
    overlayUpdatePos() { this.updatePos(); }
    addOverlayMoveUpdated(fn: CallbackUpdate) { this.addMoveUpdated(fn); }
    setOverlayDisabled(disabled: boolean) { this.setDisabled(disabled); }
    overlaySetPos(pos: Pos) { this.setPos(pos); }
}
