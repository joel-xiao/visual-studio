...
class BindKeys {
  ...
  #checkShortcuts(event: KeyboardEvent): void {
    ...
    for (const shortcut of this.#shortcuts.values()) {
      ...
      // Handle Mac Cmd vs Win Ctrl for 'ctrl' property if desired, 
      // but usually we want explicit meta/ctrl.
      // For cross-platform shortcuts, we can check both.
      ...
      if (matchCtrl && matchShift && matchAlt && matchMeta) {
        ...
        // Only prevent default if action was handled? 
        // Most shortcuts should prevent default.
      }
    }
  }
